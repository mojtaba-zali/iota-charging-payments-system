<template>
  <div class="wallet">
    <b-message :closable="false" title="Car UI" type="is-primary">
      <b-steps v-model="stepValue" type="is-primary">
        ...
        >
          <div class="flex">
            <p class="content">Generate Car Acccount</p>
            <b-button
              type="is-primary"
              :loading="generateLoaderFlag"
              @click="generateCarChargerAccount('generate')"
            >
              Generate
            </b-button>
          </div>
        ...
        >
          <div class="flex">
            <p class="content">Check for Charger Address</p>
            <b-button
              type="is-primary"
              :loading="generateLoaderFlag"
              @click="generateCarChargerAccount('check')"
            >
              Check
            </b-button>
          </div>
          <div v-if="!tryAgainTransaction" class="content">
...
export default Vue.extend({
  ...
  methods: {
    ...
    async generateCarChargerAccount(input: string) {
      ...
      if(input === 'generate') {
        this.$buefy.notification.open({
          duration: 3000,
          message: "Car Account and Address Generated.",
          position: "is-bottom-right",
          type: "is-success",
        });
      } else {
        this.$buefy.notification.open({
          duration: 3000,
          message: "Charge Address Received, Ready for Transfer",
          position: "is-bottom-right",
          type: "is-success",
        });
      }
    ...
    async submitTransaction() {
      ...
      if (this.amount === 0) {
        ...
        if (response.status === 200) {
          ...
          this.$buefy.notification.open({
            duration: 3000,
            message: "Charger Address not Generated",
            position: "is-bottom-right",
            type: "is-danger",
          });
        }
